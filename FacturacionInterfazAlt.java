...
public class FacturacionInterfazAlt extends JFrame {
    ...
    // Método para cargar productos de ejemplo
    private void cargarProductosEjemplo() {
        productos.add(new Producto("Leche", 10.50));
        productos.add(new Producto("Pan", 5.25));
        productos.add(new Producto("Huevos", 15.75));
    }
